...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[height=0.18\textheight]{fig_umap_36h_optimized.png}
    \caption{36h}
    \label{fig:umap_36h}
  \end{subfigure}
  \vskip\baselineskip
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[height=0.18\textheight]{fig_umap_48h_optimized.png}
    \caption{48h}
    \label{fig:umap_48h}
  \end{subfigure}
  \hfill
...
\begin{figure}[H]
\centering
\includegraphics[height=0.7\textheight, width=\textwidth]{varianciatotal_boxplot.png}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.2\textheight, width=\textwidth]{variancia_tempos.png}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.2\textheight, width=\textwidth]{expression_of_genes_in_pigment_cells_over_time.png}
