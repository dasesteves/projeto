...
\begin{figure}[H]
\centering
\includegraphics[height=0.5\textheight, width=0.5\textwidth]{varianciatotal_boxplot.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[height=0.2\textheight, width=0.5\textwidth]{expression_of_genes_in_pigment_cells_over_time.png}
